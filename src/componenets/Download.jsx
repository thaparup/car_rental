...
export default function Download() {
  return (
    <section className="py-[8rem]  px-[7.2rem] lg:px-[6.2rem] md:px-[5.2rem] sm:px-[3.8rem] xsm:px-[1.4rem] bg-[url('src/assets/banners/bg02.png')] min-h-[3rem] bg-no-repeat bg-cover">
